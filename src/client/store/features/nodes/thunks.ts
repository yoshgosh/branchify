...
export const listNodesThunk = createAsyncThunk<
    { nodes: Node[] },
    { graphId: string }
>("nodes/list", async ({ graphId }) => {
...
export const removeNodeThunk = createAsyncThunk<
    { node: Node | null },
    { nodeId: string }
>("nodes/remove", async ({ nodeId }) => {
...
export const generateNodeTitleThunk = createAsyncThunk<
    { node: Node },
    { nodeId: string }
>("nodes/generateTitle", async ({ nodeId }) => {
