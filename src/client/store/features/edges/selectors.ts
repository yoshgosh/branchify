...
export const edgeSelectors = edgeAdapter.getSelectors(
...
export const selectEdgeIdsByGraphId =
...
export const selectParentNodeIdMapByGraphId = createCachedSelector(
    (graphId: string) =>
...
export const selectChildNodeIdMapByGraphId = createCachedSelector(
    (graphId: string) =>
        createSelector(selectEdgesByGraphId(graphId), (edges) => {
